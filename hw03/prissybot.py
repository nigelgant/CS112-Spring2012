...
user_name = raw_input("Enter your name: ")#gets username
print "PrissyBot: Hello there", user_name
input = raw_input(user_name+": ")#gets user input
print "PrissyBot: You mean, '" + input + ", sir!'"#echoes input with "sir"

print "PrissyBot: So, " + user_name + ". Do you think your pathetic human brain can handle some simple arithmetic? Y/n"
inp = raw_input(user_name+": [Y/n]")
if inp.lower().startswith("n"):#if input starts with "n" prints the following
    ...
    print "PrissyBot: Well aren't we optimistic today!"#otherwise prints this
...
print n, "+", m, "=", n+m#does simple math (+,-,*,/) with user input
print n, "-", m, "=", n-m
print n, "*", m, "=", n*m
print n, "/", m, "=", n/m

print "PrissyBot: Ok " + user_name + ", take a few minutes to wrap your head around that, and then we will step it up a notch."
...
print "PrissyBot: Even worse! Anyway, here's " + a + " to the power of " + b +"."
a = int(a)
b = float(b)

print a, "**", b , "=", a**b #input a to the power of input b
...
inp = raw_input(user_name+": [Y/n]")
if inp.lower().startswith("n"): #same if statement as above
...
x = raw_input("PrissyBot: Ready " + user_name + "? Take a few deep breaths and give me a number between one and infinity: ")
y = raw_input("PrissyBot: Almost done; Just enter one more number: ")
x = int(x)
y = float(y)

print x, "*", y, "=", x*y #input x * input y

print "PrissyBot: Now we take the square root of that and we get:"

print math.sqrt(x*y) #takes square root of (x*y)
print "PrissyBot: Hey " + user_name + ". Are you still with me?"

inp = raw_input(user_name+": [Y/n]")
if inp.lower().startswith("n"): #same if statement
